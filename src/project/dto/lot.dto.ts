...
export class CreateLotDto {
  ...
  @IsNotEmpty({ message: 'El ID de la manzana es requerido' })
  @IsUUID('all', { message: 'El ID de la manzana debe ser un UUID válido' })
  blockId: string;
}
...
/**
 * DTO para la respuesta de un lote
 */
