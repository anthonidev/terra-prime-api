...
@Entity('lots')
@Unique(['name', 'block']) // El nombre debe ser único dentro de la manzana
export class Lot {
    ...
    @IsNumber({}, { message: 'El precio de habilitación urbana debe ser un número' })
    @Min(0, { message: 'El precio de habilitación urbana debe ser mayor o igual a 0' })
